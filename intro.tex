...
On the other hand, in his monograph \cite{hadzihasanovic2024combinatorics}, Hadzihasanovic takes a synthetic approach to the theory of higher categorical diagrams, modeled by his regular directed complexes.
...
\begin{center}
    \begin{tikzcd}
        ...
        \arrow[""{name=2, anchor=center, inner sep=0}, shift right=3, from=2-1, to=1-1]
        \arrow[hook, from=2-1, to=2-3]
        \arrow[""{name=3, anchor=center, inner sep=0}, shift right=3, from=2-3, to=1-3]
...
A \emph{comap of regular directed complexes} is given by an order-preserving function \( c \colon Q \to P \) such that, for all \( x \in P \), \( k \in \mathbb{N} \) and \( \a \in \set{-, +} \), 
\begin{enumerate}
...
The \emph{suspension of \( P \)} is the oriented graded poset with underlying set given by
\begin{equation*}
