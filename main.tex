...
\begin{center}
	\begin{minipage}[t]{.95\textwidth}
		...
		We make strict \( \omega \)\nbd categories even stricter by requiring they satisfy higher exchange laws governed by Hadzihasanovic's theory of regular directed complexes. 
		% We show that stricter \( \omega \)\nbd categories are stable under Gray products and suspension.
		We then transfer the folk model structure on strict \( \omega \)\nbd categories to the category of stricter \( \omega \)\nbd categories, and that the latter 
	\end{minipage}
